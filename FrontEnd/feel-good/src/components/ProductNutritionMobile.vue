<template>
  <div class="product-nutrition-mobile" :style="'background-color: ' + product.color">
...
<style lang="scss" scoped>
  ...
  .product-nutrition-mobile.active{
    top: 0;
  }
