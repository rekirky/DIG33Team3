...
<section class="data-types">
  <div class="container">
    ...
    <p>While using our Service, we may ask you to provide us with certain personally identifiable information that can be
      used to contact or identify you ("Personal Data"). Personally identifiable information may include, but is not limited to:</p>
...
<section class="data-use">
  <div class="container">
    ...
    <h6>Tracking and Cookies Data</h6>
    ...
    <h6>Use of Data</h6>
    <p>Little Brown Dogs uses the collected data for various purposes:</p>    
    <ul class="policy-list">
...
<section class="data-transfer">
  <div class="container">
    ...
    <p>Feel-Good Drinks will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
...
<section class="data-security">
  <div class="container">
    ...
    <p>We may employ third party companies and individuals to facilitate our Service ("Service Providers"), to provide
      the Service on our behalf, to perform Service-related services or to assist us in analyzing how our Service is used.</p>
